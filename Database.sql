DROP DATABASE IF EXISTS reservation_schema;
CREATE DATABASE IF NOT EXISTS reservation_schema;
...
CREATE TABLE Includes (
    ...
    FOREIGN KEY (ResrNo)
        REFERENCES Reservation (ResrNo),
    FOREIGN KEY (AirlineID , FlightNo , LegNo)
        REFERENCES Leg (AirlineID , FlightNo , LegNo)
);
...
CREATE TABLE ReservationPassenger (
    ...
    FOREIGN KEY (ResrNo)
        REFERENCES Reservation (ResrNo),
    FOREIGN KEY (Id , AccountNo)
        REFERENCES Passenger (Id , AccountNo)
);
